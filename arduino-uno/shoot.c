/* 
 * shoot.c -- ARDUINO UNO code
 * v1.0
 * Created: May 12, 2017 09:45:27 AM
 * Author: Francesco Urbani
 * demo aruino uno: https://youtu.be/ytz441CO3a4
 * 
 *
 *	note:
 *	plug the IR pcb into pin [1, 3] of 
...
void setup(void)
{
	...
	DDRD |= (VCC | GND);    /* set VCC and GND i.e. digital pins 1 and 2 as output */
	PORTD |= VCC;           /* set VCC high */
	PORTD &= ~GND;          /* set GND low */
